...
/*--------------------------------------------------------------
  Criando a tabela de Tipos de Alunos
 -------------------------------------------------------------*/
CREATE TABLE tbTipoAluno(
...
CREATE TABLE tbAlunos(
    ...
    IdTipoAluno INT NOT NULL
);

ALTER TABLE tbAlunos
ADD CONSTRAINT fk_aluno_tipo FOREIGN KEY (IdTipoAluno) REFERENCES tbTipoAluno (IdTipo);
...
ADD CONSTRAINT fk_matricula_curso FOREIGN KEY (IdCurso) REFERENCES tbCursos(IdCurso),
ADD CONSTRAINT fk_matricula_aluno FOREIGN KEY (IdAluno) REFERENCES tbAlunos(IdAluno);

/*--------------------------------------------------------------
  Inserindo registros de exemplo na tabela de Tipos de Alunos
 -------------------------------------------------------------*/
INSERT INTO tbTipoAluno (IdTipo, Tipo) VALUES (1, "Aluno regular");
INSERT INTO tbTipoAluno (IdTipo, Tipo) VALUES (2, "Aluno de intercâmbio");

/*--------------------------------------------------------------
  Inserindo registros de exemplo na tabela de Alunos
 -------------------------------------------------------------*/
INSERT INTO tbAlunos VALUES (1, 'Joana da Silva', '12001', '2010-05-15', 1);
INSERT INTO tbAlunos VALUES (2, 'Pedro Paulo de Souza', '12002', '2012-03-01', 1);
INSERT INTO tbAlunos VALUES (3, 'João Rabino', '12003', '2011-06-10', 1);
INSERT INTO tbAlunos VALUES (4, 'Lucas Fernandes Costa', '12004', '2012-02-05', 1);
INSERT INTO tbAlunos VALUES (5, 'Cintia Machado', '12005', '2011-06-02', 1);
INSERT INTO tbAlunos VALUES (6, 'Milena Costa e Silva', '12006', '2010-12-17', 1);
INSERT INTO tbAlunos VALUES (7, 'Carlos Eduardo Meireles', '12007', '2009-07-10', 1);
INSERT INTO tbAlunos VALUES (8, 'Luciana Navarra Obregon', '12008', '2011-01-03', 2);
INSERT INTO tbAlunos VALUES (9, 'José Luiz Castanho', '12009', '2005-07-01', 1);
INSERT INTO tbAlunos VALUES (10, 'Carla Helena das Dores', '12010', '2010-06-15', 1);
INSERT INTO tbAlunos VALUES (11, 'Letícia Lesner', '12011', '2010-03-03', 2);
